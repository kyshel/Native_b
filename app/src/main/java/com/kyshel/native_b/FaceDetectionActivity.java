...
import static com.kyshel.native_b.R.*;
...
public class FaceDetectionActivity extends AppCompatActivity implements CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_face_detection);

        mOpenCvCameraView = (CameraBridgeViewBase) findViewById(id.fd_activity_surface_view);
